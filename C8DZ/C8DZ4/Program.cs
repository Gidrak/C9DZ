...
Console.Clear();
int deep1 = InputInt("Введите 1 размерность: ");
int deep2 = InputInt("Введите 2 размерность: ");
int deep3 = InputInt("Введите 3 размерность: ");
int countNums = 125;

if (deep1 * deep2 * deep3 > countNums)
{
    Console.Write("Массив великоват");
    return;
}
